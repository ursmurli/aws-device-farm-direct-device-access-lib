...
public class DeviceFarmClient {
     ...
     */
    public DirectDeviceSession createDirectDeviceAccessSession(DirectDeviceAccessCapabilities capabilities) {
     ...
     * @param capabilities {@link DirectDeviceAccessCapabilities}.
     */
    private RemoteAccessSession createRemoteAccessSession(final DirectDeviceAccessCapabilities capabilities) {
        ...
        request.setSshPublicKey(awsDirectory.getPublicKeyString());
        ...
        while (sessionTimeout.isAfter(Instant.now())) {
            ...
            logger.info("Status: {}, Session arn: {}, ", session.getStatus(),
